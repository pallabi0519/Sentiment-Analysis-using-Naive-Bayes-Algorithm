...
###### positive class wordclass
pos_wordcloud = WordCloud(background_color='black')
pos_wordcloud.generate_from_frequencies(pos_dictionary)
...
plt.axis('off')
#plt.show()
#plt.savefig('positive_wordcloud.png', dpi=1000)

###### negative class wordclass ###### 
neg_wordcloud = WordCloud(background_color='black')
neg_wordcloud.generate_from_frequencies(neg_dictionary)
...
plt.axis('off')
#plt.show()
#plt.savefig('negitive_wordcloud.png', dpi=1000)
